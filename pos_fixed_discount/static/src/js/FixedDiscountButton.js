odoo.define("pos_fixed_discount.FixedDiscountButton", function (require) {
    ...
    class FixedDiscountButton extends PosComponent {
        ...
        async onClick() {
            ...
            if (confirmed) {
                var val = Math.round(Math.max(0, Math.min(100000000000000000000000000000, parseFloat(payload))));
        ...
        async apply_discount(amount) {
            ...
            var product = this.env.pos.db.get_product_by_id(
                this.env.pos.config.fixed_discount_product_id[0]
            );
    ...
    ProductScreen.addControlButton({
        ...
        condition: function () {
            return (
                ...
                this.env.pos.config.fixed_discount_product_id
            );
        },
    });
